...
function Products() {
  ...
  return (
    <div className="main-container pt-2 pb-10 flex flex-col justify-center items-center">
      ...
      <div className="Second-Part grid lg:max-w-[1200px] lg:grid-cols-5 sm:grid-cols-3 grid-cols-2 gap-2 lg:px-12 ">
