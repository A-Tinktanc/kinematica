...
function News() {
  ...
  return (
    <div>
      <div className="max-w-[1280px] grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-3 py-3 px-3 mx-auto lg:px-10 ">
        {newaData.map((data) => (
          <div
            key={data.id}
      ...
      <div className="bg-gray-400 h-[1px] mb-4 lg:mx-auto  w-[90%] mt-10 max-w-[1280px]   "></div>
    </div>
  );
}
